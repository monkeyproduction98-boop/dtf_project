...
with col1:
    st.markdown(
        ...
        <a href="dtf_dashboard" target="_self">
            <div style="border:2px solid #ddd; border-radius:15px; padding:20px; text-align:center; 
                ...
                <img src="https://img.freepik.com/free-vector/calculator-floating-cartoon-vector-icon-illustration-finance-business-icon-concept-isolated-flat_138676-9297.jpg"
                     style="border-radius:10px; margin-bottom:15px; max-width:100%; height:auto;">
...
with col2:
    st.markdown(
        """
        <a href="report_page" target="_self">
            <div style="border:2px solid #ddd; border-radius:15px; padding:20px; text-align:center; 
                        box-shadow:2px 2px 8px rgba(0,0,0,0.1);">
